...
func quickStyle(o quickStyleOpts) Styles {
	...
	// QuitSummary
	s.Dialog.QuitSummary.Frame = lipgloss.NewStyle().
		BorderForeground(o.primary).
		Border(lipgloss.RoundedBorder()).
		Padding(1, 2)

	s.Dialog.QuitSummary.Title = lipgloss.NewStyle().
		Bold(true).
		Foreground(o.fgBase).
		Background(o.bgLessVisible).
		Padding(0, 1)

	s.Dialog.QuitSummary.SectionHeader = lipgloss.NewStyle().
		Foreground(o.separator)

	s.Dialog.QuitSummary.Label = lipgloss.NewStyle().
		Foreground(o.fgBase).
		Bold(true)

	s.Dialog.QuitSummary.Value = lipgloss.NewStyle().
		Foreground(o.fgMoreSubtle)

	s.Dialog.QuitSummary.StatusCompleted = lipgloss.NewStyle().
		Foreground(o.success)

	s.Dialog.QuitSummary.StatusInterrupted = lipgloss.NewStyle().
		Foreground(o.destructive)

	s.Dialog.QuitSummary.Divider = lipgloss.NewStyle().
		Foreground(o.separator)

	s.Dialog.QuitSummary.Resume = lipgloss.NewStyle().
	...
	s.Toast.SuccessIndicator = lipgloss.NewStyle().
		Foreground(o.success).SetString("✓ ")
	s.Toast.SuccessMessage = lipgloss.NewStyle().
		Foreground(o.success).Padding(0, 1)
	s.Toast.InfoIndicator = lipgloss.NewStyle().
		Foreground(o.info).SetString("ℹ ")
	s.Toast.InfoMessage = lipgloss.NewStyle().
		Foreground(o.info).Padding(0, 1)
	s.Toast.UpdateIndicator = lipgloss.NewStyle().
		Foreground(o.primary).SetString("◌ ")
	s.Toast.UpdateMessage = lipgloss.NewStyle().
		Foreground(o.primary).Padding(0, 1)
	s.Toast.WarnIndicator = lipgloss.NewStyle().
		Foreground(o.warning).SetString("▲ ")
	s.Toast.WarnMessage = lipgloss.NewStyle().
		Foreground(o.warning).Padding(0, 1)
	s.Toast.ErrorIndicator = lipgloss.NewStyle().
		Foreground(o.destructive).SetString("✗ ")
	s.Toast.ErrorMessage = lipgloss.NewStyle().
		Foreground(o.destructive).Padding(0, 1)
