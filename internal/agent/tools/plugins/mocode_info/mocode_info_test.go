...
func TestMocodeInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildMocodeInfo(cfg, nil, nil, nil, nil)
...
func TestMocodeInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/mocode/mocode.json",
		"/project/.mocode/mocode.json",
	)
	output := buildMocodeInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/mocode/mocode.json")
	require.Contains(t, output, "/project/.mocode/mocode.json")
}

func TestMocodeInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildMocodeInfo(cfg, mgr, nil, nil, nil)
...
func TestMocodeInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.Mocode",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.Mocode")
	require.Contains(t, output, "debug = true")
}

func TestMocodeInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildMocodeInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildMocodeInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestMocodeInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "mocode.json")
	...
	output := buildMocodeInfo(store, nil, nil, nil, nil)
...
func TestMocodeInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "mocode-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("mocode-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildMocodeInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "mocode-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestMocodeInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "mocode-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestMocodeInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestMocodeInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
