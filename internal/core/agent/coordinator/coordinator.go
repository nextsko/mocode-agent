...
// Package-local aliases keep the migrated files unchanged.
type (
	SessionAgent     = lifecycle.SessionAgent
	SessionAgentCall = lifecycle.SessionAgentCall
	Model            = lifecycle.Model
	AgentCallbacks   = lifecycle.AgentCallbacks
)
