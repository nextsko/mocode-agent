...
func (m *mockSessionService) UpdateTitleAndUsage(context.Context, string, string, int64, int64, int64, int64, float64) error {
	return nil
}
...
func (m *mockSessionService) IncrementCost(context.Context, string, float64) error {
	return nil
}
