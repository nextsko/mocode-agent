...
Mocode update-providers

# Update Catwalk providers from a custom URL
Mocode update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
Mocode update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
Mocode update-providers embedded

# Update Hyper provider information
Mocode update-providers --source=hyper

# Update Hyper from a custom URL
Mocode update-providers --source=hyper https://hyper.example.com
`,
