...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View Mocode logs",
	Long:  `View the logs generated by Mocode. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(infra.DataDir(), "logs", mocodelog.MainLogFileName)
