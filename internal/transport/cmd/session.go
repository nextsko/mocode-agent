...
var sessionCmd = &cobra.Command{
	...
	Long:    "Manage Mocode sessions. Agents can use --json for machine-readable output.",
}
...
func sessionSetup(cmd *cobra.Command) (context.Context, *sessionServices, func(), error) {
	...
	return ctx, svc, func() { st.Close() }, nil
}
...
func resolveSessionID(ctx context.Context, svc *store.SessionStore, id string) (session.Session, error) {
