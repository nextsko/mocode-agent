...
//     session/message or proto instead
...
//
// # Three-Layer ToolResult Architecture
//
// mocode has three ToolResult types by design:
//
//  1. session/message.ToolResult — RUNTIME, implements ContentPart (~80+ uses)
//  2. proto.ToolResult — SERIALIZATION, implements ContentPart
//  3. types.ToolResult — DTO, public, no ContentPart (this package)
//
// These cannot be unified via type alias due to Go's sealed interface
// pattern. See internal/types/tool.go for full details and conversion
// functions.
package types
